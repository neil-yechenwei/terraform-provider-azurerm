...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ConnectedCluster -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/resGroup1/providers/Microsoft.Kubernetes/connectedClusters/connectedCluster1
