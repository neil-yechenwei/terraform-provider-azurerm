...
func TestAccAzureRMKubernetes_all(t *testing.T) {
	...
	testCases := map[string]map[string]func(t *testing.T){
		...
		//	"upgradeKubernetesVersion":       testAccAzureRMKubernetesClusterNodePool_upgradeKubernetesVersion,
		//},
		"other": {
			...
			//"upgradeKubernetesVersionWithAvailabilitySet": testAccAzureRMKubernetesCluster_upgradeKubernetesVersionWithAvailabilitySet,
			//"upgradeKubernetesVersionWithVirtualMachineScaleSets": testAccAzureRMKubernetesCluster_upgradeKubernetesVersionWithVirtualMachineScaleSets,
		},
		//"scaling": {
		...
		//	"upgradeKubernetesVersion":                    testAccDataSourceAzureRMKubernetesCluster_upgradeKubernetesVersion,
		//},
	}
