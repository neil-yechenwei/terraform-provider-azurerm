...
func TestAccBotChannelsRegistration(t *testing.T) {
	...
	acceptance.RunTestsInSequence(t, map[string]map[string]func(t *testing.T){
		...
		"channel": {
			...
			"telegramBasic":          testAccBotChannelTelegram_basic,
			"telegramUpdate":         testAccBotChannelTelegram_update,
			"telegramRequiresImport": testAccBotChannelTelegram_requiresImport,
