...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=EventHubNamespacePrivateEndpointConnection -id=/subscriptions/12345678-1234-9876-4563-123456789012/resourceGroups/group1/providers/Microsoft.EventHub/namespaces/namespace1/privateEndpointConnections/privateEndpointConnection1
