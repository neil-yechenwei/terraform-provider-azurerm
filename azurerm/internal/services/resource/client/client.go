...
type Client struct {
	...
	TemplateSpecVersionsClient *templatespecs.VersionsClient
}
...
func NewClient(o *common.ClientOptions) *Client {
	...
	templateSpecVersionsClient := templatespecs.NewVersionsClientWithBaseURI(o.ResourceManagerEndpoint, o.SubscriptionId)
	o.ConfigureClient(&templateSpecVersionsClient.Client, o.ResourceManagerAuthorizer)
	...
	return &Client{
		...
		TemplateSpecVersionsClient: &templateSpecVersionsClient,
	}
}
