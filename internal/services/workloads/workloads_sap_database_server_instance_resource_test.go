...
func TestAccWorkloadsSAPDatabaseServerInstance_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_database_server_instance", "test")
	r := WorkloadsSAPDatabaseServerInstanceResource{}
...
func TestAccWorkloadsSAPDatabaseServerInstance_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_database_server_instance", "test")
	r := WorkloadsSAPDatabaseServerInstanceResource{}
...
func TestAccWorkloadsSAPDatabaseServerInstance_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_database_server_instance", "test")
	r := WorkloadsSAPDatabaseServerInstanceResource{}
...
func TestAccWorkloadsSAPDatabaseServerInstance_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_database_server_instance", "test")
	r := WorkloadsSAPDatabaseServerInstanceResource{}
...
func (r WorkloadsSAPDatabaseServerInstanceResource) Exists(ctx context.Context, clients *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
	id, err := sapdatabaseinstances.ParseDatabaseInstanceID(state.ID)
	if err != nil {
		return nil, err
	}

	client := clients.Workloads.SAPDatabaseInstances
...
func (r WorkloadsSAPDatabaseServerInstanceResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r WorkloadsSAPDatabaseServerInstanceResource) basic(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s

resource "azurerm_workloads_sap_database_server_instance" "test" {
  name                    = "acctest-sapdb-%d"
  resource_group_name     = azurerm_resource_group.test.name
  location                = azurerm_resource_group.test.location
...
func (r WorkloadsSAPDatabaseServerInstanceResource) requiresImport(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
resource "azurerm_workloads_sap_database_server_instance" "import" {
  name                    = azurerm_workloads_sap_database_server_instance.test.name
  resource_group_name     = azurerm_workloads_sap_database_server_instance.test.resource_group_name
  location                = azurerm_workloads_sap_database_server_instance.test.location
  sap_virtual_instance_id = azurerm_workloads_sap_database_server_instance.test.sap_virtual_instance_id
}
`, r.basic(data))
}

func (r WorkloadsSAPDatabaseServerInstanceResource) complete(data acceptance.TestData, tags string) string {
	return fmt.Sprintf(`
%s
resource "azurerm_workloads_sap_database_server_instance" "test" {
  name                    = "acctest-sapdb-%d"
