...
func TestAccWorkloadsSAPCentralServerInstanceResource_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_central_server_instance", "test")
	r := WorkloadsSAPCentralServerInstanceResource{}
...
func TestAccWorkloadsSAPCentralServerInstance_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_central_server_instance", "test")
	r := WorkloadsSAPCentralServerInstanceResource{}
...
func TestAccWorkloadsSAPCentralServerInstance_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_central_server_instance", "test")
	r := WorkloadsSAPCentralServerInstanceResource{}
...
func TestAccWorkloadsSAPCentralServerInstance_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_workloads_sap_central_server_instance", "test")
	r := WorkloadsSAPCentralServerInstanceResource{}
...
func (r WorkloadsSAPCentralServerInstanceResource) Exists(ctx context.Context, clients *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
	id, err := sapcentralinstances.ParseCentralInstanceID(state.ID)
	if err != nil {
		return nil, err
	}

	client := clients.Workloads.SAPCentralInstances
...
func (r WorkloadsSAPCentralServerInstanceResource) template(data acceptance.TestData) string {
	return fmt.Sprintf(`
provider "azurerm" {
  features {}
}
...
func (r WorkloadsSAPCentralServerInstanceResource) basic(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s
...
func (r WorkloadsSAPCentralServerInstanceResource) requiresImport(data acceptance.TestData) string {
	return fmt.Sprintf(`
%s

resource "azurerm_workloads_sap_central_server_instance" "import" {
  name                    = azurerm_workloads_sap_central_server_instance.test.name
  resource_group_name     = azurerm_workloads_sap_central_server_instance.test.resource_group_name
  location                = azurerm_workloads_sap_central_server_instance.test.location
  sap_virtual_instance_id = azurerm_workloads_sap_central_server_instance.test.sap_virtual_instance_id
}
`, r.basic(data))
}

func (r WorkloadsSAPCentralServerInstanceResource) complete(data acceptance.TestData, tags string) string {
	return fmt.Sprintf(`
%s
