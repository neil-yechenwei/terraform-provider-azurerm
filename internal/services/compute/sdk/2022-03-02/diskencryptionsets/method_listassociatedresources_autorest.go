...
func (c DiskEncryptionSetsClient) ListAssociatedResourcesComplete(ctx context.Context, id DiskEncryptionSetId) (ListAssociatedResourcesCompleteResult, error) {
	return c.ListAssociatedResourcesCompleteMatchingPredicate(ctx, id, stringOperationPredicate{})
}

// ListAssociatedResourcesCompleteMatchingPredicate retrieves all of the results and then applied the predicate
func (c DiskEncryptionSetsClient) ListAssociatedResourcesCompleteMatchingPredicate(ctx context.Context, id DiskEncryptionSetId, predicate stringOperationPredicate) (resp ListAssociatedResourcesCompleteResult, err error) {
	items := make([]string, 0)
