...
var serviceTestConfigurationOverrides = mapOf(
        ...
        // netapp has a max of 10 accounts and 25 TiB capacity pool per subscription so lets limit it to 1 to account for broken ones, run Monday, Wednesday, Friday
